...
INSERT INTO users (email, password_hash, first_name, last_name, created_at) VALUES
    ('james.elner@email.com', '$2a$10$KUyOdyP2njeVp8Jjr04IMuuzyALi41U6OfdJ2qFU9QVdFeo8UeNMu', 'James', 'Elner', '2024-01-15 10:30:00+00');
...
INSERT INTO accounts (user_id, account_name, account_type, balance, currency, is_active, created_at) VALUES
    (1, 'Monzo', 'CURRENT', 3245.67, 'GBP', true, '2024-01-15 11:00:00+00'),
...
INSERT INTO categories (user_id, category_name, category_type, color_code, is_system, created_at) VALUES
    (NULL, 'Groceries', 'EXPENSE', '#4573FF', true, '2024-01-01 00:00:00+00'),
    (NULL, 'Transport', 'EXPENSE', '#FF9F45', true, '2024-01-01 00:00:00+00'),
    (NULL, 'Shopping', 'EXPENSE', '#F299EA', true, '2024-01-01 00:00:00+00');

-- James's Custom Categories
INSERT INTO categories (user_id, category_name, category_type, color_code, is_system, created_at) VALUES
    (1, 'Pub / Going Out', 'EXPENSE', '#F29999', false, '2024-01-15 11:30:00+00'),
    (1, 'Takeaway / Dinner Out', 'EXPENSE', '#FF5454', false, '2024-01-15 11:31:00+00'),
    (1, 'Fun / Exercise', 'EXPENSE', '#92D47D', false, '2024-01-15 11:32:00+00'),
    (1, 'Clothes', 'EXPENSE', '#FFEA73', false, '2024-01-15 11:33:00+00'),
    (1, 'Personal Development / Tech', 'EXPENSE', '#A1A1A1', false, '2024-01-15 11:34:00+00'),
    (1, 'Personal Care', 'EXPENSE', '#CFC902', false, '2024-01-15 11:35:00+00'),
    (1, 'Holidays', 'EXPENSE', '#00DEF7', false, '2024-01-15 11:36:00+00');
